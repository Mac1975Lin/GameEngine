...
public:
	...
	virtual void setCompressedLevel(ProjectModel::CompressedLevel coordsys_);
	virtual ProjectModel::CompressedLevel getCompressedLevel();
///////////////////////////////////////////////////////////////////////////////////
	...
	bool loadSceneGraphCoreJson(const char *path, const Vector3 &offset = Vector3::ZERO);
	bool loadEntitiesJson(InputStream &is, const Vector3 &offset = Vector3::ZERO);
	bool saveSceneGraphCoreJson(const char *path);
	bool saveEntitiesJson(OutputStream &os, Vector<Entity *> &entities);
protected:
private:
///////////////////////////////////////////////////////////////////////////////////
public:
