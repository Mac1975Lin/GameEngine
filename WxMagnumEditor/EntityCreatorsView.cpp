			 ...
			 wxLC_REPORT | wxLC_NO_HEADER | wxNO_BORDER | wxLC_SINGLE_SEL)
{
	...
	imglist->Add(wxArtProvider::GetBitmap(wxART_FOLDER, wxART_OTHER, wxDefaultSize));
	imglist->Add(wxArtProvider::GetBitmap(wxART_NORMAL_FILE, wxART_OTHER, wxDefaultSize));
