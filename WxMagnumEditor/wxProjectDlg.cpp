...
: wxDialog(0, -1, title, wxDefaultPosition, wxSize(1280, 600))
, projectFolderPath("")
, selectListIndex(-1)
{
...
wxPanel *wxProjectDlg::addOpenProjectPage(wxBookCtrlBase *parent)
{
	...
	recentProjectPathCtrl->SetColumnWidth(0, 640);
	...
	panel->SetSizer(vBox1);
		...
		vBox1->Add(hBox1				, 0, wxGROW | (wxLEFT | wxRIGHT | wxBOTTOM), 8);
			...
			hBox1->Add(0, COLLAPSE_BUTTON_SIZE, 1);
...
wxPanel *wxProjectDlg::addCreateProjectPage(wxBookCtrlBase *parent)
{
	...
	wxListCtrl		*listCtrl				= new wxListCtrl(panel, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxLC_REPORT | wxLC_NO_HEADER | wxLC_SINGLE_SEL);
...
bool wxProjectDlg::showProjectFilePathDlg(wxString &projectFolderPath)
{
	wxFileDialog openDialog(this, wxT("Open Project"), wxEmptyString, wxEmptyString, 
							wxT("DreamEngine Project files (*.magnumproj)|*.magnumproj"),
